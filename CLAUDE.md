...
- [docs/protocol.md](docs/protocol.md) — USB-CDC wire protocol between receiver and gateway (v0.6, variable-length TV frames + air magic/version header)
